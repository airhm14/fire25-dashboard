...
동일 입력으로 독립 전략을 생성한다.  manual_guard 통과 전 원시 전략을 반환.
"""
...
def run(
    *,
    ...
    """Execute Claude strategy agent."""
    meta: dict[str, Any] = {"_agent": "claude", "_source": "fallback", "_debug_error": None}
